  ...
  runApp(MultiProvider(
    providers: [
      ...
      ChangeNotifierProvider(
          create: (context) => ThemeViewModel()..getNightMode()),
    ],
    child: MyApp(),
  ));
  configLoading();
    ...
    return Consumer<ThemeViewModel>(
      builder: (context, themeViewModel, child) => MaterialApp(
        ...
        onGenerateRoute: (settings) {
          ...
          if (settings.name == SignUpPage.pageName) {
            ...
            return MaterialPageRoute(
                builder: (context) => MainPage(userId: args));
        ...
        theme: ThemeData(
            ...
            accentIconTheme: IconThemeData(color: Colors.black38),
            textTheme: TextTheme(
                bodyText2: TextStyle(
                    color: Colors.black87,
                    fontSize: 16.0,
